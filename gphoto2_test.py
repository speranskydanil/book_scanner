...
class Device:
  ...
  @classmethod
  def all(cls):
    return [Device('Canon EOS 500D', 'usb:001'), Device('Canon EOS 500D', 'usb:002')]
  ...
  def capture(self, path):
    ...
    self._exec('convert -size 2000x2000 xc:white -pointsize 1000 -draw "text 100,1500 \'{0}\'" "{1}"'.format(text, path))
